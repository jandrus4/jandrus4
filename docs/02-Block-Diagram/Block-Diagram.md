...
The second block diagram shows the final product's block diagram. Due to a complication in coding and incorrect footprints for the PCB, the final product fell short of what the original design desired.
